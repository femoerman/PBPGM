...
#' @keywords r-K Bayesian parallel model fitting
#' @export
#' @import tidyverse
#' @import rstan
#' @import loo
...
#' @examples
#' rK()
rK <- function(dd, K.prior, Ksd.prior, r0.prior, r0sd.prior, N0.prior, N0sd.prior, sdev.prior=1,
  ...
  error <- CheckInput(dd, K.prior, Ksd.prior, r0.prior, r0sd.prior, d.prior=NA, dsd.prior=NA, N0.prior, N0sd.prior, sdev.prior,
                      cores, iter, warmup, chains, graphname, outputtype, modelname=modelname)
