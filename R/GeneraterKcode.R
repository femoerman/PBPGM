...
#' @examples
#' GeneratrKHcode()
GeneraterKcode <- function(K.prior, Ksd.prior, r0.prior, r0sd.prior, N0.prior, N0sd.prior, sdev.prior){
  part1 <- '
  // function that caclulates r-alpha logistic population growth
  functions{
